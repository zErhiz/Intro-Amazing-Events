...
fetch(url)
  ...
  .then(datos => 
    ...
    for (const categoria in categoriasEventosFuturos) {
      ...
      console.log(`- Estimación de asistencia promedio: ${asistenciaPromedio.toFixed(2)}%`);
      console.log(`- Ganancias totales estimadas: $${categoriasEventosFuturos[categoria].gananciasTotal}`);
    ...
    for (const categoria in categoriasEventosPasados) {
      ...
      console.log(`${categoria}:`);
      console.log(`- Asistencia promedio: ${asistenciaPromedio}%`);
      console.log(`- Ganancias totales: ${categoriasEventosPasados[categoria].gananciasTotal}$`);
